...
CREATE TABLE `trn_payments` (
  ...
  `payment_method` enum('BANK_TRANSFER','UPI','CASH','CARD','PAYPAL','STRIPE','OTHER') DEFAULT NULL,
  ...
  KEY `fk_payment_invoice` (`sales_invoice_id`),
  KEY `fk_payment_received_by` (`received_by`),
  CONSTRAINT `fk_payment_invoice` FOREIGN KEY (`sales_invoice_id`) REFERENCES `trn_sales_invoice` (`sales_invoice_id`),
  CONSTRAINT `fk_payment_received_by` FOREIGN KEY (`received_by`) REFERENCES `mst_users` (`id`)
